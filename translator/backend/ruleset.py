...
class RuleMissing(NotImplementedError):
    def __init__(self, category: str, node):
        self.category = category
        self.node = node
        super().__init__(f"No {category} rule for {type(node).__name__}")
